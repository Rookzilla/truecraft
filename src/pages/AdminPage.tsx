...
const storedPasswordKey = 'truecraft-admin-password'
...
export function AdminPage() {
  const [password, setPassword] = useState(() => window.sessionStorage.getItem(storedPasswordKey) ?? '')
      ...
      <section className="admin-page">
        <form
          ...
          onSubmit={(event) => {
            ...
            window.sessionStorage.setItem(storedPasswordKey, inputPassword)
                        ...
                        {isOpen ? (
                          <div className="candidate-detail">
                            ...
                            <div className="candidate-actions">
                              <button
                                type="button"
                                disabled={candidate.scanStatus !== 'NO_THREATS_FOUND'}
                              ...
                              <button
                                type="button"
                                disabled={candidate.status === 'publicly_available' || candidate.scanStatus !== 'NO_THREATS_FOUND'}
